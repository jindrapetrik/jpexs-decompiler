...
### Stable versions
A new stable version is created automatically by the GitHub Actions CI when merging  `dev` branch into `master`.
To such version a tag is added in format `versionx.y.z`.
