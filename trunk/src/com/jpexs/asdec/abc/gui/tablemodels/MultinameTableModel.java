...
public class MultinameTableModel implements TableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 2:
                if (rowIndex == 0) return "";
                if (abc.constants.constant_multiname[rowIndex].name_index == -1) return "";
                return abc.constants.constant_multiname[rowIndex].getName(abc.constants);
            case 3:
                if (rowIndex == 0) return "";
                if (abc.constants.constant_multiname[rowIndex].namespace_index == -1) return "";
                return abc.constants.constant_multiname[rowIndex].getNamespace(abc.constants).getNameWithKind(abc.constants);
            case 4:
                if (rowIndex == 0) return "";
                if (abc.constants.constant_multiname[rowIndex].namespace_set_index == -1) return "";
