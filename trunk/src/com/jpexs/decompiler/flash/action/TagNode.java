            ...
            if ((node.tag instanceof ASMSource) && (node.export)) {
               ...
               try {
                  ...
                  if (isPcode) {
                     ...
                     List<com.jpexs.decompiler.flash.action.Action> as = ((ASMSource) node.tag).getActions(SWF.DEFAULT_VERSION);
                     com.jpexs.decompiler.flash.action.Action.setActionsAddresses(as, 0, SWF.DEFAULT_VERSION);
                     ret = (Highlighting.stripHilights(com.jpexs.decompiler.flash.action.Action.actionsToSource(as, SWF.DEFAULT_VERSION)));
                  }
