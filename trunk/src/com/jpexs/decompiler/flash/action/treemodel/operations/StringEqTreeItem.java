...
public class StringEqTreeItem extends BinaryOpItem {

   public StringEqTreeItem(GraphSourceItem instruction, GraphTargetItem leftSide, GraphTargetItem rightSide) {
