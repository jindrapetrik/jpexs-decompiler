 ...
 * @author JPEXS
 */
public class LoadMovieTreeItem extends TreeItem {

    private GraphTargetItem urlString;
    private GraphTargetItem targetString;
    private int method;

    public LoadMovieTreeItem(GraphSourceItem instruction, GraphTargetItem urlString, GraphTargetItem targetString, int method) {
