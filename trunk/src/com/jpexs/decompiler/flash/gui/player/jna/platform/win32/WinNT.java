...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
   ...
   public abstract class SECURITY_IMPERSONATION_LEVEL {
       ...
       * local system. The server cannot impersonate the client on remote
       * systems.
       */
   ...
   public static class LUID_AND_ATTRIBUTES extends Structure {
      ...
      public LUID Luid;
      /**
       * Specifies attributes of the LUID. This value contains up to 32 one-bit
   ...
   /**
    * The SID_NAME_USE enumeration type contains values that specify the type of
   ...
   public abstract class WELL_KNOWN_SID_TYPE {
      ...
      /**
       * Indicates a SID for a network account. This SID is added to the process
       * of a token when it logs on across a network. The corresponding logon
       ...
       * of a token when it logs on as a batch job. The corresponding logon type
       * is LOGON32_LOGON_BATCH.
       */
      ...
      /**
       * Indicates a SID that allows a user to create incoming forest trusts. It
       * is added to the token of users who are a member of the Incoming Forest
       * Trust Builders built-in group in the root domain of the forest.
       */
    ...
    * and information about product suites and the latest Service Pack installed
    * on the system.
    */
   public static class OSVERSIONINFOEX extends Structure {
       ...
       * system. For example, for Service Pack 3, the major version number is 3.
       ...
       * system. For example, for Service Pack 3, the minor version number is 0.
       */
   ...
   public static class EVENTLOGRECORD extends Structure {
      ...
      /**
       * Size of this event record, in bytes. Note that this value is stored at
       * both ends of the entry to ease moving forward or backward through the
       * log. The length includes any pad bytes inserted at the end of the
      ...
      /**
       * Category for this event. The meaning of this value depends on the event
       * source.
       */
      ...
      /**
       * Offset of the event-specific information within this event log record,
       * in bytes. This information could be something specific (a disk driver
       * might log the number of retries, for example), followed by binary
       * information specific to the event being logged and to the source that
       * generated the entry.
       */
