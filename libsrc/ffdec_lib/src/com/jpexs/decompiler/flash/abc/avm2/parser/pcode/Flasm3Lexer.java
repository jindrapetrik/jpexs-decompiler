 ...
 * <tt>C:/Dropbox/Programovani/JavaSE/FFDec/libsrc/ffdec_lib/lexers/actionscript3_pcode.flex</tt>
 */
    ...
    public ParsedSymbol yylex() throws java.io.IOException, AVM2ParseException {
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                ...
                case 36: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_ITEM, yytext());
                }
                case 151:
                    break;
                case 37: {
                ...
                case 68: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_EXTENDS, yytext());
                }
                case 183:
                    break;
                case 69: {
                ...
                case 74: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_METADATA_BLOCK, yytext());
                }
                case 189:
                    break;
                case 75: {
                ...
                case 76: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_INSTANCE, yytext());
                }
                case 191:
                    break;
                case 77: {
                ...
                case 202:
                    break;
                case 88: {
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_INTERFACE, yytext());
                }
                case 203:
                    break;
                case 89: {
                ...
                case 92: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_IMPLEMENTS, yytext());
                }
                case 207:
                    break;
                case 93: {
                ...
                case 96: {
                    yybegin(PARAMETERS);
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_PROTECTEDNS_BLOCK, yytext());
                }
                case 211:
                    break;
                case 97: {
                ...
                case 212:
                    break;
                case 98: {
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_PROTECTEDNS, yytext());
                }
                case 213:
                    break;
                case 99: {
                ...
                case 214:
                    break;
                case 100: {
                    return new ParsedSymbol(ParsedSymbol.TYPE_KEYWORD_NON_NULLABLE, yytext());
                }
                case 215:
                    break;
                case 101: {
