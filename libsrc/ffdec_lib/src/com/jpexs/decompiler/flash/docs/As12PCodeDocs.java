...
public class As12PCodeDocs extends AbstractDocs {
    ...
    public static String getDocsForIns(String insName, boolean ui, boolean standalone, boolean nightMode) {
    ...
    public static String getAllInstructionDocs(boolean nightMode) {
        ...
        for (String name : s) {
            ...
            sb.append("\t\t\t\t").append(getDocsForIns(name, false, false, nightMode).trim().replace(NEWLINE, NEWLINE + "\t\t\t\t")).append(NEWLINE);
