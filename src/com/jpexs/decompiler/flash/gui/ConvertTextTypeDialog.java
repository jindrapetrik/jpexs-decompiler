 ...
 * @author JPEXS
 */
public class ConvertTextTypeDialog extends AppDialog {
    
    private List<JRadioButton> radios = new ArrayList<>();

    private int result = 0;            
    
    public ConvertTextTypeDialog(Window owner, int currentTextType) {
        super(owner);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            radio.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    okButton.setEnabled(fi != currentTextType - 1);
                }
            });
