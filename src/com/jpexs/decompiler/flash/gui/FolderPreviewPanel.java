...
public class FolderPreviewPanel extends JPanel {
    ...
    private SerializableImage renderImage(SWF swf, TreeItem treeItem) {
        ...
        if (imgSrc == null) {
            ...
            drawable.toImage(swf, 0, 0, 0, new RenderContext(), image, image, false, m, new Matrix(), m, m, null, scale, false, viewRectangle, true, Timeline.DRAW_MODE_ALL, 0, !Configuration.disableBitmapSmoothing.get());
        } else {
